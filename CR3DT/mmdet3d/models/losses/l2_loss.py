# from qd_track https://github.com/SysCV/qdtrack/blob/c5b10472d7bdd3b9ab75255dd10e48e21f48c54f/qdtrack/models/losses/l2_loss.py
...
class L2Loss(nn.Module):
    ...
    def update_weight(self, pred, target, weight, avg_factor):
        ...
        if num_pos > 0: # to avoid division by zero
